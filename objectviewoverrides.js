...
$overrides.prototype = {
	...
	var params = ["param",{ns:xhtmlns, name:"ipaddress",value:"127.0.0.1"},[],
	    "param",{ns:xhtmlns, name:"code",value:((jQuery.browser.msie)?"Initialize":"Initialize.class")},[],
	    "param",{ns:xhtmlns, name:"archive",value:"vnc.jar"},[],
//	    "param",{ns:xhtmlns, name:"type",value:"application/x-java-applet;version=1.5"},[],
	...
	if(jQuery.browser.msie) {
	    ...
	    consolestuff=["object",{ns:xhtmlns, classid:"java:Initialize.class", type:"application/x-java-applet", archive:"vnc.jar", width:"100%",height:"300px"},params];
	}
